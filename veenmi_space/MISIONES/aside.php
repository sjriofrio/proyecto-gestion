...
<head>
  ...
  <style>
    ...
    .formulario_Registro_Astronauta {
      height: 100vh;
      max-width: 500px;
      margin: 0 auto;
      padding: 20px;
    ...
    .formulario_Registro_Astronauta h1 {
      text-align: center;
      margin-bottom: 20px;
    }

    .formulario_Registro_Astronauta form {
      display: flex;
      flex-direction: column;
    }

    .formulario_Registro_Astronauta .form-group {
      margin-bottom: 20px;
    }

    .formulario_Registro_Astronauta label {
      font-weight: bold;
    }

    .formulario_Registro_Astronauta input[type="text"],
    .formulario_Registro_Astronauta input[type="number"],
    .formulario_Registro_Astronauta textarea {
      width: 100%;
      padding: 10px;
    ...
    .formulario_Registro_Astronauta button[type="submit"] {
      padding: 10px 20px;
    ...
    .formulario_Registro_Astronauta button[type="submit"]:hover {
